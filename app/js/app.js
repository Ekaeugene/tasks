...
myApp
  .service('CrudeTaskService', function($http) {
...
myApp
  .service('UpdateWindowState', function($http){
...
myApp
  .controller('ListController', ['$scope', 'CrudeTaskService', 'UpdateWindowState',
...
myApp
  .controller('CrudeController', ['$scope', '$uibModal','CrudeTaskService', function($scope, $uibModal, CrudeTaskService) {
      var $ctrl = this;
...
myApp
  .controller('PopUpUpdate', ['$scope','$uibModalInstance', 'CrudeTaskService', 'items', '$timeout','UpdateWindowState', function ($scope, $uibModalInstance, CrudeTaskService, items, $timeout, UpdateWindowState) {
